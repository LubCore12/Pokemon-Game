...
class Character(Entity):
    ...
    def has_los(self):
        if (
            pygame.Vector2(self.rect.center).distance_to(self.player.rect.center)
            < self.radius
        ):
            collisions = [
    ...
    def start_move(self):
        relation = (
            pygame.Vector2(self.player.rect.center) - pygame.Vector2(self.rect.center)
        ).normalize()
